...
class GeneralizedNormalProcessor:
    ...
    def get_light_samples_gpu(self, light_cfg, P_surf_full):
        ...
        if 'ax_u' in light_cfg and 'ax_v' in light_cfg:
            ...
            print(f"  [Warning] Light {light_cfg['id']} is missing explicit ax_u/ax_v. Using dummy vector fallback.")
    ...
    def run(self):
        ...
        for j, l_cfg in enumerate(self.cfg['lights']):
            ...
            numeric_id = l_cfg['id'].lstrip('L').lstrip('0')
            img_path = Path(self.cfg['paths']['image_dir']) / f"light_{numeric_id}.exr"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        cfg_path = r"D:\Chandana\Photometric_Stereo\photometric_stereo_simulation\blender_render\renders\config_test_5\config_test_5.json"
