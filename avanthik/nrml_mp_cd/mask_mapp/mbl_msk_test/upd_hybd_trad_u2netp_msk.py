...
class HybridMaskerU2NetP:
    ...
    def process(self):
        ...
        # 1. Use ELLIPTICAL kernels instead of square ones to prevent blocky/staircase edges
        ...
        # 2. Mathematical Edge Melting (Anti-Aliasing)
        # We heavily blur the harsh binary mask, then re-threshold it right at the middle (127).
        # This acts as a low-pass filter, mathematically melting away micro-jaggies and sharp corners.
        ...
        if contours:
            # We can also use approxPolyDP here if we want to force geometric smoothness, 
            # but the Gaussian melt usually looks much more natural for organic objects.
...
if __name__ == "__main__":
    ...
    config_file = r"C:\Users\vishn\Desktop\avanthik\nrml_mp_cd\mask_mapp\mbl_msk_test\upd_hybd_trad_u2netp_msk_cfg.json"
